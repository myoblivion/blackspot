...
const DirectionComponent = ({ currentRoute }) => {
  ...
  return (
    <div className="direction wrapper">
      <div className="wrapper-all-direction">
            ...
            <div className="box-direction">
              ...
              <div className="direction-content">
                ...
                <ul>
                  ...
                  <li>
                    <strong>BGC Bus Station</strong> <br /> From BGC Bus
                    Station, get off to 25th St. or Finance Corporation
                    Building/ Infinity Building
                  </li>
                  <li>
                    {" "}
                    <strong>25th Street (The Finance Corporation)</strong>{" "}
                    <br /> From 25th Street its just 2 minute walk to Infinity
            ...
            <div className="box-direction">
              ...
              <div className="direction-content">
                ...
                <ul>
                  ...
                  <li>
                    <strong> Market Market</strong> <br /> From Market market
                    walk going to SM Aura and walk ahead going to 26th Street
                    corner 11th Street.
                  </li>
          ...
          <div className="wrapper-directions" id="walk">
            <div className="box-direction">
              ...
              <div className="direction-content">
                ...
                <p>
                  Head on Mckinley Parkway and walk ahead thru 26th Street
                  corner 11th Street.
                </p>
                <h3 id="grab">
