              ...
              <div className="ggr-section-1">
                <div className="game-introduction">
                  ...
                  <p>
                    ...
                    purchased and unique cars. Ready your car, finish the line
                    and win a coin and be incentivized.
                  </p>
                </div>
                ...
                <div className="ui-guide">
                  ...
                  <ul>
                    <li>
                      ▶ Players were given with rewards on a daily basis.{" "}
                    </li>
                    <li>▶ Rewards may differ everyday. </li>
                    <li>
                      ▶ Players must login in order to receive the rewards.
                    </li>
                  </ul>
                  <hr />
                  ...
                  <ul>
                    <li>
                      ▶ Grand Prix ticket can be used as an entry ticket to
                      Grand Prix mode.
                      <Link
                        to="/grand-pix-guide"
                        {...props}
                    ...
                    <li>
                      ▶ Gacha Ticket can be used in order to get awesome
                      rewards.
                    </li>
                  </ul>
                  <hr />
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        <li>
                          Will be directed to the social media of the game
                        </li>
                      </ul>
                    </li>
                    <li>
                  ...
                  <ul>
                    <li>
                      ▶ When the player clicks Start, the player will be
                      directed to mode selection screen.
                    </li>
                  </ul>
                  <hr />
                  ...
                  <h4>Drifting</h4>
                  <p>
                    ▶ By pressing the drift button and gaining momentum, the
                    drift meter will fill up in order to gain Nitro.
                  </p>
                  <hr />
                  <h4>Drift Boost</h4>
                  <p>
                    ▶ After drifting for a long period of time without crashing,
                    you’ll gain a short boost by pressing the Acceleration
                    button.
                  </p>
                  <img src={game3} alt="" />
                  <hr />
                  ...
                  <p>
                    ...
                    sudden boost like nitro. <br /> ▶ Boost Pads differs in
                    color which gives boost for a longer period of time. Below
                    are the color of boost pads from shortest amount of time to
                    highest:
                  </p>
                  <img src={game6} alt="" />
                  <hr />
                  ...
                  <p>
                    ...
                    the color. The grade of nitro will increase for as long as
                    you are not using your nitro and continue to drift.
                  </p>
                  <img src={game8} alt="" />
                  <hr />
                  <h4>Result</h4>
                  ...
                  <div className="speed-league">
                    ...
                    <ul>
                      <li>
                        ▶ To be on placed in Podium in order to increase
                        Ranking.
                      </li>
                    </ul>
                    <p>Mechanics</p>
                    ...
                    <ul>
                      <li>
                        ▶ DNF is enabled once a racer already finished the
                        racer.
                      </li>
                      <li>
                    ...
                    <ul>
                      ...
                      <li>
                        ▶ To let a team member be the first placer in order to
                        win and placed in podium
                      </li>
                    </ul>
                    <p>Mechanics:</p>
                    <ul>
                    ...
                    <img src={game12} alt="" />
                    <p>
                      Note: Item League has the same game mechanics as Time
                      Attack which was already stated above. Item only differs
                      on Speed League since players can use items and skills.
                    </p>
                    <hr />
                  ...
                  <li id="hover">
                    ...
                    <ul id="hidden">
                      ...
                      <li>
                        <HashLink
                          smooth
                          to="/gogoracing-guide#profile-contents"
                        >
                          Profile Contents
                        </HashLink>
                      </li>
                      ...
                      <li>
                        <HashLink
                          smooth
                          to="/gogoracing-guide#language-settings"
                        >
                          Language Settings
                        </HashLink>
                      </li>
